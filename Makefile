...
$(PLAYER_MOVEMENT_OUT): $(PLAYER_MOVEMENT_SRC) | $(OBJDIR)
	$(CC) -g -Ilib/include $(PLAYER_MOVEMENT_SRC) -o $(PLAYER_MOVEMENT_OUT) $(LDFLAGS)

$(GAME_MAP_OUT): $(GAME_MAP_SRC) | $(OBJDIR)
	$(CC) -g -Ilib/include $(GAME_MAP_SRC) -o $(GAME_MAP_OUT) $(LDFLAGS)
...
ifeq ($(PLATFORM),windows)
	...
	rm -rf $(OBJDIR) $(CLIENT_OUT) $(SERVER_OUT) $(PLAYER_MOVEMENT_OUT) $(GAME_MAP_OUT)
endif