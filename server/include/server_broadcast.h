...
void cleanupServer(UDPsocket server_socket, TCPsocket tcp_socket, SDLNet_SocketSet socket_set, TCPsocket *vote_sockets, UDPpacket *receive_packet, UDPpacket *send_packet);
